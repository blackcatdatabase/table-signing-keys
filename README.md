...
> Lineage: 3 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 7 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\signing-keys](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\signing-keys) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package signing-keys -Apply
