...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'algo_id', 'name', 'kms_key_id', 'origin', 'status', 'scope', 'created_by', 'created_at', 'activated_at', 'retired_at', 'notes' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'crypto_algorithms' => 'j0', 'kms_keys' => 'j1', 'users' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SigningKeys\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SigningKeys\Definitions::softDeleteColumn();
