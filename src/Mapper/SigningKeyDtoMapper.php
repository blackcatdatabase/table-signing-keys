...
namespace BlackCat\Database\Packages\SigningKeys\Mapper;

use BlackCat\Database\Packages\SigningKeys\Dto\SigningKeyDto;
use BlackCat\Database\Packages\SigningKeys\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO SigningKeyDto:
...
final class SigningKeyDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'algo_id' => 'algoId', 'name' => 'name', 'public_key' => 'publicKey', 'private_key_enc' => 'privateKeyEnc', 'private_key_enc_key_version' => 'privateKeyEncKeyVersion', 'kms_key_id' => 'kmsKeyId', 'origin' => 'origin', 'status' => 'status', 'scope' => 'scope', 'created_by' => 'createdBy', 'created_at' => 'createdAt', 'activated_at' => 'activatedAt', 'retired_at' => 'retiredAt', 'notes' => 'notes' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'algo_id', 'kms_key_id', 'created_by' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const BIN_COLS    = [ 'public_key', 'private_key_enc' ];
     ...
     */
    public static function fromRow(array $row): SigningKeyDto
    {
        /** @var SigningKeyDto */
    ...
    public static function fromRowOrNull(?array $row): ?SigningKeyDto
    {
     ...
     *
     * @param SigningKeyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SigningKeyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SigningKeyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SigningKeyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SigningKeyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SigningKeyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SigningKeyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SigningKeyDto>
     */
