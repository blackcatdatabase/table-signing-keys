...
namespace BlackCat\Database\Packages\SigningKeys;
...
use BlackCat\Database\Packages\SigningKeys\Repository\SigningKeyRepository as GeneratedRepository;
...
{
  private SigningKeyRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SigningKeyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SigningKeyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SigningKeys\Dto\SigningKeyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SigningKeys\Dto\SigningKeyDto|null { return $this->repo->getById($id, $asDto); }
