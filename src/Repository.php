...
use BlackCat\Database\Packages\SigningKeys\Repository\SigningKeyRepository;
...
final class Repository
{
    ...
    {
        $this->repo = new SigningKeyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SigningKeys\Dto\SigningKeyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SigningKeys\Dto\SigningKeyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SigningKeys\Dto\SigningKeyDto|null
    {
