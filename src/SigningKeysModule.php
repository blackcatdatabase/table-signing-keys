...
final class SigningKeysModule implements ModuleInterface
{
    public function name(): string { return 'table-signing_keys'; }
    public function table(): string { return 'signing_keys'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-crypto_algorithms', 'table-kms_keys', 'table-users' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_sk_algo_status' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_sk_algo', 'fk_sk_kms', 'fk_sk_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_sk_algo_status' ],
            'foreignKeys' => [ 'fk_sk_algo', 'fk_sk_kms', 'fk_sk_user' ],
        ];
    }
}
